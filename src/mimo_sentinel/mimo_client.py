            ...
            "messages": [
                {
                    "role": "system",
                    "content": (
                        "You are MiMo Sentinel, an evidence-bound incident analyst. "
                        "Return JSON matching IncidentReport fields. Cite event IDs for every hypothesis."
                    ),
                },
                {
                    "role": "user",
                    "content": {
                        "service": service,
                        "events": [event.model_dump() for event in events[:400]],
                    },
                },
            ],
